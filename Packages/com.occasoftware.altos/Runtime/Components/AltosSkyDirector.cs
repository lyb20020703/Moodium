...
namespace OccaSoftware.Altos.Runtime
{
    ...
    public class AltosSkyDirector : MonoBehaviour
    {
        ...
        private CloudState cloudState = null;
        private Weathermap weathermap = null;
    ...
    public class Weathermap : IDisposable
    {
        ...
        /// <br/>The cloud map is computed relative to the camera, so the position does not need to be transformed to account for origin offset.
        /// </summary>
