...
namespace OccaSoftware.Altos.Runtime
{
    ...
    public class SkyDefinition : ScriptableObject
    {
        ...
        {
            new PeriodOfDay("Night", 6f, new Color32(36, 21, 36, 255), new Color32(35, 4, 46, 255), new Color32(26, 23, 26, 255)),
            new PeriodOfDay("Day", 7f, new Color32(123, 153, 173, 255), new Color32(18, 25, 59, 255), new Color32(14, 12, 10, 255)),
            new PeriodOfDay("Day", 18f, new Color32(123, 153, 173, 255), new Color32(18, 25, 59, 255), new Color32(14, 12, 10, 255)),
            new PeriodOfDay("Night", 19f, new Color32(36, 21, 36, 255), new Color32(35, 4, 46, 255), new Color32(26, 23, 26, 255))
        };
        ...
        {
            return StaticHelpers.Frac(systemTime / 24);
        }
        ...
        private void HandleSkyColor(float time)
        {
            ...
            float t = StaticHelpers.Remap(time, startTime, periodsOfDay[nextPeriodIndex].startTime, 0, 1);
        ...
        public void SetLightingEnvironment(SkyColorSet skyColorSet)
        {
            ...
            float exposure = environmentLightingExposure;
            exposure *= (
                1.0f - Mathf.Max(AltosSkyDirector.Instance.GetCurrentPrecipitation(), AltosSkyDirector.Instance.GetCurrentCloudiness()) * 0.8f
            );
            RenderSettings.ambientGroundColor = Exposure(Saturation(skyColorSet.groundColor, environmentLightingSaturation), exposure);
            RenderSettings.ambientEquatorColor = Exposure(Saturation(skyColorSet.equatorColor, environmentLightingSaturation), exposure);
            RenderSettings.ambientSkyColor = Exposure(Saturation(skyColorSet.skyColor, environmentLightingSaturation), exposure);
        }
    }
