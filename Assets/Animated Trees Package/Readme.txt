This package contains 30 fully animated trees.
...
The 'Static' one contains all trees in non animated version.
Open any folder. You will find 11 subfolders there that represent species of trees.

To see all trees open SampleScene. You can click the buttons on the screen to switch between all trees included in the pack.
