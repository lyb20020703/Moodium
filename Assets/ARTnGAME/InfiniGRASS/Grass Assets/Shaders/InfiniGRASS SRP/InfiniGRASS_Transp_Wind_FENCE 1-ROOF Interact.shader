...
Shader "InfiniGRASS/InfiniGrass Directional Wind ROOF Interact" {
    Properties {
...
//						}
        ...
        //        		_WaveYFactor = _WaveYFactor - (1-distA)*(1-distA)*SpeedFac.x*1;
						o.posWorld.x = o.posWorld.x - clamp(_InteractSpeed.x*(1 - distA)*(o.uv0.y - 0.5), -_InteractMaxoffset, _InteractMaxoffset);// *(1 - distA)*_InteractMaxYoffset*(o.uv0.y - 0.5)*sin(o.posWorld.z + _Time.y);
						o.posWorld.z = o.posWorld.z - clamp(_InteractSpeed.z*(1 - distA)*(o.uv0.y - 0.15), -_InteractMaxoffset, _InteractMaxoffset);;// *(1 - distA)*_InteractMaxYoffset*(o.uv0.y - 0.5)*sin(o.posWorld.z + _Time.y);
						o.posWorld.y = o.posWorld.y - clamp(_InteractSpeed.y*(1 - distA)*(o.uv0.y - 0.15), -_InteractMaxoffset, _InteractMaxoffset);;
					}
                	if( o.uv0.y > 0.5){
