...
{
    /// <summary>
    /// DOTween Transform 消失效果：从当前 Transform 状态 tween 到配置的 to（仅对勾选属性做动画）。
    /// </summary>
    public class TransformDisappear : MonoBehaviour, IDisappearEffect
    {
        [Tooltip("结束效果作用的内容（根节点需有 Transform）。")]
        ...
        [SerializeField] private Vector3 scaleTo = Vector3.zero;
